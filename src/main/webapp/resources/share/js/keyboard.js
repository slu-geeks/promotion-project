/* ********************************************************************
 *             This keyword has been developed by Mehdi Afsari        *
 *             and is under the copyright of HotPersia company        *
 *  															      *
 **********************************************************************/
...
(function() {
	...
	this.VKI_kts = this.VKI_kt = "\u0641\u0627\u0631\u0633\u06cc";
	// layout
	...
	this.VKI_imageURI = "http://hp-g2fx.rhcloud.com/public/img/keyboard.png";
	// imageless mode
	this.VKI_clickless = 0; // 0 = disabled, > 0 = delay in ms
	this.VKI_activeTab = 0; // Tab moves to next: 1 = element, 2 = keyboard
	// enabled element
	...
	this.VKI_layout['Rom\u00e2n\u0103'] = {
		...
		'keys' : [
				...
				[
						...
						[ "k", "K" ],
						[ "l", "L", "\u0142", "\u0141" ],
						[ (this.VKI_isIElt8) ? "\u015F" : "\u0219",
								(this.VKI_isIElt8) ? "\u015E" : "\u0218", ";",
								":" ],
						[ (this.VKI_isIElt8) ? "\u0163" : "\u021B",
								(this.VKI_isIElt8) ? "\u0162" : "\u021A", "\'",
								"\"" ], [ "Enter", "Enter" ] ],
				[ [ "Shift", "Shift" ], [ "\\", "|" ], [ "z", "Z" ],
						[ "x", "X" ], [ "c", "C", "\u00A9" ], [ "v", "V" ],
	...
	this.VKI_layout['\u05d9\u05d9\u05b4\u05d3\u05d9\u05e9'] = { // from
		// http://www.yv.org/uyip/hebyidkbd.txt
		// http://uyip.org/keyboards.html
		'name' : "Yiddish",
		'keys' : [
				[ [ ";", "~", "\u05B0" ], [ "1", "!", "\u05B1" ],
						[ "2", "@", "\u05B2" ], [ "3", "#", "\u05B3" ],
	...
	this.VKI_layout['\u05d9\u05d9\u05b4\u05d3\u05d9\u05e9 \u05dc\u05e2\u05d1\u05d8'] = { // from
		// http://jidysz.net/
	...
	this.VKI_deadkey['"'] = this.VKI_deadkey['\u00a8'] = this.VKI_deadkey['\u309B'] = { // Umlaut
		// /
		// Diaeresis
		// /
		// Greek
	...
	this.VKI_deadkey["'"] = this.VKI_deadkey['\u00b4'] = this.VKI_deadkey['\u0384'] = { // Acute
		// /
		// Greek
		// Tonos
		'a' : "\u00e1",
	...
	VKI_attach = function(elem) {
		...
		if (self.VKI_imageURI) {
			...
			spanbut.setAttribute("style", "margin-right: 6px !important;");
			upperSpan.className = "input-group-btn";
			...
			spanbut.appendChild(keybut);
			upperSpan.appendChild(spanbut);
			elem.parentNode.insertBefore(upperSpan, elem.previousSibling);
		} else {
	...
	if (this.VKI_showVersion) {
		...
		vr.title = this.VKI_i18n['12'] + " " + this.VKI_i18n['09'] + " for "
				+ this.VKI_company;
		vr.appendChild(document.createTextNode(this.VKI_i18n['12'] + " "
				+ this.VKI_company));
		div.appendChild(vr);
	}
	td.appendChild(div);
					...
					VKI_addListener(
							...
							function() {
								...
								if (self.VKI_target.setSelectionRange
									...
									var rng = [ self.VKI_target.selectionStart,
